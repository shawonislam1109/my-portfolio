    ...
    return (
        <div id='contact' className='my-16 px-10 lg:px-0'>
            ...
            <div data-aos="fade-up"
                ...
                <div className='mt-16'>
                    <input type="text" placeholder="Your name" className="input input-bordered input-error w-full max-w-2xl mt-3 text-2xl text-slate-100 bg-none" />
                    <br />
                    <input type="text" placeholder="Your Email" className="input input-bordered input-error w-full max-w-2xl mt-3 text-2xl text-slate-100" />
                    <br />
                    <textarea className="textarea text-2xl text-slate-100 textarea-error mt-3 h-60 w-full max-w-2xl" placeholder="Message "></textarea>
                    <input type="button" value="Submit" className='bg-slate-200 text-black p-2 mt-2 text-xl font-serif rounded-md cursor-pointer' />
                </div>
