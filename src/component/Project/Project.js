        ...
        <div className='my-10 mx-5 md:mx-0 ' id='project'>
            ...
            <div className='flex md:justify-end justify-start'>
                <div className='my-10 relative'>
                    ...
                    <div className='absolute top-10 md:top-24 p-3 left-32 md:left-52 w-52 h-36 bg-slate-100 rounded-md'>
            ...
            <div className='flex justify-start'>
                <div className='my-10 relative'>
                    ...
                    <img data-aos="zoom-in-left" data-aos-duration="2000" className='w-52 h-56 md:w-80 md:h-96 rounded-xl' src={learning} alt="" />
                    <div className='absolute top-10 md:top-24 p-3 left-32 md:left-52 w-52 h-36 bg-slate-100 rounded-md'>
            ...
            <div className='flex md:justify-end justify-start'>
                <div className='my-10 relative'>
                    ...
                    <div className='absolute top-10 md:top-24 p-3 left-32 md:left-52 w-52 h-40 bg-slate-100 rounded-md'>
